                ...
                <div className={styles.imageGrid}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <h3 style={{ color: 'white', fontSize: '28px', margin: 0, fontFamily: 'var(--font-bebas)', fontWeight: 'bold' }}>
                                Premium Cars
                            </h3>
                    ...
                    >
                        <h3 style={{ color: 'black', fontFamily: 'var(--font-bebas)', fontSize: '48px', fontWeight: '900', margin: 0, lineHeight: 0.9 }}>
                            900+
                        </h3>
                        <span style={{ color: 'black', fontWeight: '800', fontSize: '10px', textTransform: 'uppercase', letterSpacing: '1px', marginTop: '10px' }}>
                            Satisfied Clients
                        </span>
                    </motion.div>
                ...
                <div className={styles.bottomRow}>
                    <div className={styles.textSide}>
                        ...
                        <ul className={styles.bullets} role="list">
                            {evChargers.bullets.map((bullet: string, i: number) => (
                                <li key={i} className={styles.bullet}>
                                    ...
                                    </div>                                    <p className={styles.bulletText}>{bullet}</p>
                                </li>
                            ))}
                        </ul>
                    </div>
