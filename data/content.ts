export const siteContent = {
  ...
  ctaFooter: {
    ...
    body:
      'Join thousands of drivers who have already made the switch to electric. Rent a Timeless vehicle today and experience the future of mobility — zero emissions, full performance.',
    navColumns: [
      [
