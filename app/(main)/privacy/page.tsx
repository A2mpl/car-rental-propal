        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            ...
            <section className={styles.section}>
              ...
              <p>Le site <strong>timeless-cars.fr</strong> est édité par :</p>
              <ul className={styles.list}>
                <li><strong>Raison sociale :</strong> Timeless SAS</li>
                ...
                <li><strong>Contact :</strong> <a href="mailto:contact@timeless-cars.fr" className={styles.link}>contact@timeless-cars.fr</a></li>
              </ul>
            </section>
            ...
            <section className={styles.section}>
              ...
              <ul className={styles.list}>
                ...
                <li><strong>Site web :</strong> <a href="https://vercel.com" className={styles.link} target="_blank" rel="noopener noreferrer">vercel.com</a></li>
              </ul>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                de rectification, d'effacement, de portabilité et d'opposition au traitement de vos données
                personnelles.
              </p>
              <p>
                ...
                <a href="mailto:privacy@timeless-cars.fr" className={styles.link}>privacy@timeless-cars.fr</a>.
              </p>
              <p>
                Vous avez également le droit d'introduire une réclamation auprès de la CNIL (Commission Nationale
                de l'Informatique et des Libertés) — <a href="https://www.cnil.fr" className={styles.link} target="_blank" rel="noopener noreferrer">www.cnil.fr</a>.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                traçage publicitaire n'est déposé sans votre consentement explicite. Vous pouvez à tout moment
                modifier vos préférences en matière de cookies via les paramètres de votre navigateur.
              </p>
              <p>
                Pour en savoir plus sur la gestion des cookies, consultez le site de la CNIL :{' '}
                <a href="https://www.cnil.fr/fr/cookies-et-autres-traceurs" className={styles.link} target="_blank" rel="noopener noreferrer">
